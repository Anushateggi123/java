...
public class Exam{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("------------------------------------");
		exam.subjects = SubjectsInCourse.JAVA;
		exam.result = Results.FAIL;
		...
		System.out.println("------------------------------------");
		alphabets.letters = Alphabets1.R;
		alphabets.universalVOwels = Vowels.A;
		...
		System.out.println(human.noOfHead);
		System.out.println("------------------------------------");
